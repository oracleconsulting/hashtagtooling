    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-white">UK Shipping</h2>
            <div className="bg-brand-dark-card border border-brand-dark-border p-6 rounded-lg space-y-4">
              <div>
                <h3 className="font-semibold mb-2 text-white">Standard Delivery (Royal Mail)</h3>
                <p className="text-zinc-400">£5.99 - 3-5 business days</p>
              </div>
              <div>
                <h3 className="font-semibold mb-2 text-white">Express Delivery (Royal Mail Special Delivery)</h3>
                <p className="text-zinc-400">£12.99 - Next business day (order before 2pm)</p>
              </div>
              <div>
                <h3 className="font-semibold mb-2 text-white">Free Shipping</h3>
                <p className="text-zinc-400">On orders over £150</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-brand-dark-card border border-brand-dark-border p-6 rounded-lg space-y-4">
              <div>
                <h3 className="font-semibold mb-2 text-white">Europe</h3>
                <p className="text-zinc-400">£15.99 - 5-10 business days</p>
              </div>
              <div>
                <h3 className="font-semibold mb-2 text-white">Rest of World</h3>
                <p className="text-zinc-400">£25.99 - 10-15 business days</p>
              </div>
            ...
            <div className="bg-brand-dark-card border border-brand-dark-border p-6 rounded-lg">
              <ul className="space-y-3 text-zinc-400">
                <li className="flex gap-3">
                  <span className="font-semibold text-white w-32">In Stock Items:</span>
                  <span>Ships within 1-2 business days</span>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-white w-32">Made to Order:</span>
                  <span>2-3 weeks production + shipping time</span>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-white w-32">Custom Orders:</span>
                  <span>3-4 weeks production + shipping time</span>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-white w-32">Commissions:</span>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-white">Tracking</h2>
            <p className="text-zinc-400 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-white">Returns & Exchanges</h2>
            <div className="bg-brand-dark-card border border-brand-dark-border p-6 rounded-lg">
              <p className="text-zinc-400 mb-4">
