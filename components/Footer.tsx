        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-400">
              ...
              <li><Link href="/interest/bottle-opener" className="hover:text-brand-orange transition-colors">Bottle Opener — Interest / Pre-order</Link></li>
              <li><Link href="/interest/muddler" className="hover:text-brand-orange transition-colors">Hashtag Muddler — Interest / Pre-order</Link></li>
